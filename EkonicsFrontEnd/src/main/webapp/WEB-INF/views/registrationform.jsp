...
.formAlign
{
   width:"src/main/webapp/WEB-INF/views/registrationform.jsp" 50%;
   position: relative;
   top: 20%;
   left:25%;
}
...
<div class="container">
			...
			<div class="row main">
				<div class="panel-heading">
	               ...
	               <img src="<c:url value="/resources/images/logo.png"/>" class="img-circle" alt="AboutUs" width="200"
					height="200">
	               		<h3 class="title">Signup with Ekonics</h3>
